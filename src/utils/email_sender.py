...
def create_despatch_email_body(despatch_data):
    ...
    <head>
        ...
        <style>
            ...
            .content {{ padding: 15px; background-color: #fff; border-radius: 5px; }}
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p>If you have any questions regarding this shipment, please contact our customer service team.</p>
