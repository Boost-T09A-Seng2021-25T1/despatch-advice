...
from src.mongodb import getOrderInfo, addOrder, dbConnect, updateDocument, deleteDocument
    ...
    try:
        ...
        try:
            ...
            if not updated:
                return {
                    "statusCode": 500,
                    "body": json.dumps({"error": "Failed to update despatch advice"})
                }
    ...
    try:
        ...
        try:
            ...
            if not deleted:
                return {
                    "statusCode": 500,
                    "body": json.dumps({"error": "Failed to delete despatch advice"})
                }
