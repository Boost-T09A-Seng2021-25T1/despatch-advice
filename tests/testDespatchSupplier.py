...
class testDespatchSupplier(unittest.IsolatedAsyncioTestCase):
    ...
    async def testDespatchSupplierReturn(self):
        with self.assertRaises(ValueError):
            await despatchSupplier("FAKE_UUID_KDBSKMWOBFU")
